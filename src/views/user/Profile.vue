  ...
  export default {
   ...
   async upload(){
      ...
      try {
        ...
        this.editmode =true
        this.getsyncUser()
        this.alertDisplay('success','you have changed your data',2000)
        this.loading =false
          this.$router.push('/')
        ...
        this.errors = err;
        this.loading =false
       this.alertDisplay('error',err.data.msg,2000)
        
      }
    },
   async  savePassword(){
       try {
         await Functions.updateUserPassword({
          id:this.profile._id,
          ...
          this.dialog = false
           this.alertDisplay('success','changd passwrod succesfully',2000)
           this.$store.dispatch('setUser',null)
            this.$router.push('/')
       } catch (err) {
          this.errors = err;
           this.alertDisplay('error','error  with change password',2000)
