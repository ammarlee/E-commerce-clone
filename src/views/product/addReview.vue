    ...
    <div>
        ...
        <v-container class="text-capitalize ">
            ...
            <div class="product">
                <v-row>
                    <v-col cols="4">
                        <v-img :src="getproducts[0].img[0]" style="max-height:200px" alt="img"></v-img>
                    </v-col>
            ...
            <div class="rating ">
                ...
                <div>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam, assumenda illo harum ducimus fugiat incidunt! Fugit eligendi veritatis officia fugiat! </p>
                    <br>
                  <v-row>
                 <v-col cols='8'> 
        ...
        methods: {
           ...
           async createView(){
               ...
               this.overlay=false
                  ...
                  this.alertDisplay('success','you have added a review',2000)
                  setTimeout(() => {
                      this.$router.push('/')
                  }, 2000);
